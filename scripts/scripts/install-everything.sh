...
cargo binstall -y --locked bacon bandwhich bat bore-cli bottom cargo-edit cargo-expand cargo-modules cargo-shuttle cargo-watch difftastic diskus du-dust exa fd-find gping hexyl onefetch ripgrep rust-script starship trunk
